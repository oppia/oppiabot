...
module.exports.checkChangelogLabel = async function(context) {
  ...
  // We are already adding the default changelog label for non collaborators,
  // so here we are assining the pr author since the author is a collaborator
  // and has the permissions to add a label.
