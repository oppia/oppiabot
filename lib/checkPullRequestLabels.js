...
/**
 * Checks if the project owner can be assigned to this PR.
...
/**
 * Return the project onwer from a changelog label.
 * @param {String} changelogLabel
 */
...
/**
 * Check and assign the appropriate reviewer from the added changelog label.
 * @param {import('probot').Context} context
 */
...
/**
 * Check that changelog label is added to the PR.
 * @param {import('probot').Context} context
 */
...
/**
 * Check and prevent the removal of critical label by unauthorised users.
 * @param {import('probot').Context} context
 */
...
/**
 * Check if a label is allowed on Pull Requests.
...
/**
 * Check that an issue label has not been added to a Pull Request.
 * @param {import('probot').Context} context
 */
