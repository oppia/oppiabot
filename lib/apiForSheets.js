...
var apiForSheets = function(userNameData, contextData, isPullRequestData) {
  context = contextData;
...
module.exports.apiForSheets = apiForSheets;
module.exports.authorize = authorize;
module.exports.checkClaSheet = checkClaSheet;
