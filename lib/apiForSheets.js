...
var context, userName, isPullRequest, responseFromSheet;
...
module.exports.checkClaSheet = async function(auth) {
  ...
  await sheets.spreadsheets.values.get({
    ...
    responseFromSheet = response;
  });
  module.exports.generateOutput(responseFromSheet);
};

module.exports.generateOutput = function(response) {
