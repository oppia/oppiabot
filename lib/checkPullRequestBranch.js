...
const checkBranch = async (context) => {
  ...
  if(branchName === 'develop'){
    ...
    invalid_branch_check = true;
    message = ', PRs made from a branch whose name is prefixed with develop are not allowed.';
    ...
    invalid_branch_check = true;
    message = ', PRs made from a branch whose name is prefixed with release are not allowed.';
    ...
    invalid_branch_check = true;
    message = ', PRs made from a branch whose name is prefixed with test are not allowed.';
              
  }

  if(invalid_branch_check)
  {
