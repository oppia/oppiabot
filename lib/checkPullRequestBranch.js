  ...
  if(branchName === 'develop'){
    ...
    const commentParams = context.repo({
      ...
      body:
        ...
        'branch whose name is prefixed with release or test are not '+
        'allowed. So this PR is being closed. Please make your changes in ' +
        'another branch and send in the PR. To learn more about contributing ' +
        'to Oppia, take a look at our ' +
        wiki + ' (Rule 1 specifically). Thanks!',
    ...
    const commentParams = context.repo({
      ...
      body:
        ...
        'are not allowed. Also PRs made from develop branch or from a ' +
        'branch whose name is prefixed with develop or test are not '+
        'allowed. So this PR is being closed. Please make your changes in ' +
        'another branch and send in the PR. To learn more about contributing ' +
        'to Oppia, take a look at our ' +
        wiki + ' (Rule 1 specifically). Thanks!',
    ...
    const commentParams = context.repo({
      ...
      body:
        ...
        'are not allowed. Also PRs made from develop branch or from a ' +
        'branch whose name is prefixed with develop or release are not '+
        'allowed. So this PR is being closed. Please make your changes in ' +
        'another branch and send in the PR. To learn more about contributing ' +
        'to Oppia, take a look at our ' +
        wiki + ' (Rule 1 specifically). Thanks!',
